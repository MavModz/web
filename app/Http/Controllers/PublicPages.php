       ...
       public function addenquiries(Request $request)
{
    ...
    */
    ...
    public function aloracure(Request $request){
    
        $product = DB::table('products')
    ->join('category_products', 'category_products.product_id', '=', 'products.id')
    ->where('category_products.category_id', '=', 58)
    ->get();
        
       return view('aloracure') 
       ->with('product',$product);
    }
    
    
     public function annantcare(Request $request){
    
        $product = DB::table('products')
    ->join('category_products', 'category_products.product_id', '=', 'products.id')
    ->where('category_products.category_id', '=', 57)
    ->get();
    $products = DB::table('products')
    ->join('category_products', 'category_products.product_id', '=', 'products.id')
    ->where('category_products.category_id', '=', 56)
    ->get();
    $productss = DB::table('products')
    ->join('category_products', 'category_products.product_id', '=', 'products.id')
    ->where('category_products.category_id', '=', 55)
    ->get();
    $productsss = DB::table('products')
    ->join('category_products', 'category_products.product_id', '=', 'products.id')
    ->where('category_products.category_id', '=', 54)
    ->get();
        
       return view('annatcare') 
       ->with('product',$product)
