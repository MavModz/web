            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/home/pages/update') }}" enctype="multipart/form-data">
                        ...
                        @endif
                        <textarea name="description" id="description" required >{{ $page->description }}</textarea>
                        <br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $page->name }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="meta_keyword" type="text" class="form-control @error('meta_keyword') is-invalid @enderror" name="meta_keyword" value="{{ $page->meta_keyword }}" required autocomplete="meta_keyword" autofocus>
                                @error('meta_keyword')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="meta_description" type="text" class="form-control" name="meta_description" required>{{ $page->meta_description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="slug" class="col-md-3 col-form-label text-md-right">{{ __('Slug*') }}</label>
                            <div class="col-md-6">
                                <input id="slug" type="text" class="form-control text-lowercase @error('slug') is-invalid @enderror" name="slug" value="{{ $page->slug }}" required autocomplete="slug" autofocus>
                                @error('slug')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
