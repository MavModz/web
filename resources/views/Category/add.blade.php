    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/home/categories/add/store') }}" enctype="multipart/form-data">
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="type" class="form-control" name="type" required>
                                    ...
                                    <option value="3">Site Pages</option>
                        ...
                        <div class="form-group row">
                            <label for="meta_description" class="col-md-2 col-form-label text-md-right">{{ __('Meta Description*') }}</label>
                            <div class="col-md-6">
